...
const authAPI = {
  ...
  resetPassword: (data) =>
    axiosClient.post(
      `/api/Users/Reset-passworf?email=${data.email}&password=${data.password}&otp=${data.otp}`,
      data,
    ),
  ...
  createCustomer: (data) => axiosClient.post('/api/Users/register-return-string', data),
}
